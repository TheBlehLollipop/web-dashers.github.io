              ...
              try {
                  ...
                  if (ngText && ngText !== "-1") {
                      ...
                      if (songUrl) {
                          ...
                          const audioRes = await fetch(corsProxy + songUrl);
                          if (!audioRes.ok) throw new Error(`proxy returned ${audioRes.status}`);
